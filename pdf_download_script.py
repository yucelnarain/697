...
# %%
def download_pdfs(sample_number ,original_excel_file, path_for_converted_excel, converted_excel_sheet_name, path_for_pdfs):
    ...
    # path_for_converted_excel: '/Users/narainyucel/Google Drive/MADS/capstone/legal_nlp' 
    ...
    with xw.App(visible=False) as app:
        ...
        for sheet in wb.sheets:
            ...
            if not os.path.isfile(path_for_converted_excel + f'/{sheet.name}.xlsx'):
                wb_new.save(path_for_converted_excel + f'/{sheet.name}.xlsx')
            wb_new.close()

    #Specify xlsx_name, based on the relevant sheet
    xlsx_file = open(path_for_converted_excel + f'/{converted_excel_sheet_name}.xlsx', 'rb') 
